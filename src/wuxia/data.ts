...
export const MAPS: MapDef[] = [
  {
    ...
    elite: "bandit_chief",
    dungeon: "bandit_camp",
    sideQuests: ["side_herb", "side_sword", "side_thief"],
    npcs: [
  ...
  },
  {
    ...
    elite: "wolf_king",
    dungeon: "herb_valley",
    sideQuests: ["side_wolf", "side_poison"],
    npcs: [
  ...
  },
  {
    ...
    elite: "sword_maniac",
    dungeon: "cliff_trial",
    sideQuests: ["side_cliff", "side_swordman"],
    npcs: [
  ...
  },
  {
    ...
    elite: "cult_elder",
    dungeon: "lost_city",
    sideQuests: ["side_sand", "side_cult"],
    npcs: [
...
/** 药品（用银两在药铺购买） */
export const POTIONS: Record<string, { name: string; heal: number; mana: number; price: number }> = {
  jinchuang: { name: "金创药", heal: 120, mana: 0, price: 25 },
  dahuandan: { name: "大还丹", heal: 450, mana: 0, price: 120 },
  huichun: { name: "回春散", heal: 1600, mana: 0, price: 520 },
  jingxin: { name: "静心丸", heal: 0, mana: 80, price: 90 },
};
...
export const QUESTS: QuestDef[] = [
  // 主线 12 章
  {
    ...
    reward: { exp: 120, silver: 80, equip: "common", materials: [{ id: "jinchuang", count: 0 }] },
    next: "main_2",
  },
  {
    id: "main_2",
  ...
  // 支线
  {
    ...
    reward: { exp: 90, silver: 60, materials: [{ id: "jinchuang", count: 3 }] },
  },
  {
    id: "side_sword",
    kind: "side",
  ...
  },
  {
    ...
    reward: { exp: 380, silver: 260, materials: [{ id: "jinchuang", count: 5 }] },
  },
  {
    id: "side_poison",
    kind: "side",
